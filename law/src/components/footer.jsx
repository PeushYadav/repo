        ...
        <div className="grid grid-cols-12">
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
            <a href="#" className="flex justify-center space-x-3 md:justify-start">
              ...
              <span className="self-center text-4xl font-bold text-white">Law Lens
                <br></br>
                <p className="text-xl font-normal w-[75%]"><br></br>Describe What Happened.  We'll instantly show you the laws that protect you. Empower yourself with knowledge, clarity, and confidence because knowing your rights changes everything.</p>
              </span>
            </a>
          </div>
