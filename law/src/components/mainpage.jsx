...
const MainPage = () => {
  return (
    <div style={{ backgroundColor: '#F0ECE8' }} className="w-screen h-screen relative">
      <div className="grid gap-4 grid-cols-12 z-10 w-screen p-10">
        <div className="col-span-4 min-h-100 h-[400px] w-[95%] flex flex-wrap justify-end z-10">
          ...
          <div className="flex justify-end mt-10">
            <p className="text-left m-4 w-[75%] font-primary">
        ...
        <div className="col-span-5 min-h-100 h-[700px] w-[95%] grid z-10">
          <div className="w-auto">
            <img src={centerMain} alt="Law Lens Center" className="w-full h-full mb-10" />
          </div>
        </div>
